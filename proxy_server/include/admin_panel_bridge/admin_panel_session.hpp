...
{
    public:
        AdminPanelSession(boost::asio::ssl::stream<boost::asio::ip::tcp::socket> socket); // конструктор
    ...
    private:
        ...
        boost::asio::awaitable<void> close_session();
    ...
    private:
        ...
        boost::asio::ssl::stream<boost::asio::ip::tcp::socket> panel_socket_;
